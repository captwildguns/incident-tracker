...
WORKFLOW_STEPS = [
    ...
    ("WF-002", "step-1", 1, "Immediate Driver Response",
     ...
     "Driver", "15 minutes", True, False, [], "manual", None, None, "", None, None, None, None, None, []),
    ("WF-002", "step-2", 2, "Safety Coordinator Notification",
     "Notify safety coordinator of incident details, injuries, and any threatening behavior",
    ...
    ("WF-003", "step-1", 1, "Confiscation & Secure",
     ...
     "Driver", "15 minutes", True, False, [], "manual", None, None, "", None, None, None, None, None, []),
    ("WF-003", "step-2", 2, "Safety Coordinator & Administration Alert",
     "Notify safety coordinator and school administration; for illegal substances or weapons, notify law enforcement",
     "Driver", "15 minutes", True, False, [], "manual", None, None, "",
     None, True, True, True, False, []),
    ...
    ("WF-005", "step-1", 1, "Immediate Safety Response",
     ...
     "Driver", "15 minutes", True, False, [], "manual", None, None, "", None, None, None, None, None, []),
    ("WF-005", "step-2", 2, "Dispatch & Safety Coordinator Alert",
     "For high-severity situations (emergency exit, wrong stop): notify dispatch and safety coordinator immediately",
     "Safety Coordinator", "10 minutes", True, False, [], "manual", None, None, "",
     None, True, False, True, False, []),
...
EMAIL_TEMPLATES = [
    ...
    ("ET-002", "Parent/Guardian Notification", "Notification", True, "2026-03-17",
     ...
     "[Incident Tracker] Bus Incident Involving Your Child - {{incident_id}}",
     ...
     ["parent_name", "student_name", "bus_route", "incident_date", "incident_type", "severity",
      "incident_location", "incident_summary", "actions_taken", "contact_name", "contact_phone",
      "contact_email", "sender_name", "sender_title"]),
